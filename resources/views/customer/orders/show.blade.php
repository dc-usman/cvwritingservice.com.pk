            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title"> {{ \Illuminate\Support\Str::limit(strip_tags($order->package), 35) }} </h3>
                        ...
                        <div class="card-body">
                            ...
                            <dl class="row text-muted mb-0">
                                ...
                                <dd class="col-sm-9 mb-0">{{$order->name ?? ''}}</dd>
                                <dt class="col-sm-3 text-right mb-0">Email:</dt>
                                <dd class="col-sm-9 mb-0">{{ $order->email ?? '' }}</dd>
                                <dt class="col-sm-3 text-right mb-0">Phone:</dt>
                                <dd class="col-sm-9 mb-0">{{ $order->phone ?? '' }}</dd>
                                <dt class="col-sm-3 text-right mb-0">Country:</dt>
                                <dd class="col-sm-9 mb-0">{{ $order->country ?? '' }}</dd>
                            </dl>
                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">Attachements</h3>
                        </div>
                        <div class="card-body">
