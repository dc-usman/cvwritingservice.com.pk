        ...
        <div class="flex flex-col space-y-4 my-2 md:my-0 lg:flex-row lg:mx-4">
          @include('partials.frontend.auth-form-view')
            <div class="panel w-full sm:w-[70%] lg:w-[35%] xl:w-[30%] mx-auto ">
                <form action="{{ route('login') }}" method="POST" class="border-4 border-primary-one shadow-md rounded-lg px-4 pt-2 pb-6 flex flex-col md:ml-auto w-full space-y-2 text-white ">
                    @csrf
                    ...
                    <div class="">
                        <input id="password" type="password"
                            class="input-control @error('password') error-field @enderror" required
                    ...
                    <div class="flex w-full space-x-1">
                        <a href="{{ route('register') }}" class="py-3 w-full hover:border-primary-two border-2 border-t-green-100 rounded-lg flex justify-center items-center space-x-2">
                            <img src="{{ asset('imgs/svg/sign-up.png') }}" alt="google" width="20" height="20">
                            <span>
                                Register
                            </span>
                        </a>
                        {{-- <a href="{{ url('redirect/google') }}" class="py-3 w-1/2 hover:border-primary-two border-2 border-t-green-100 rounded-lg flex justify-center items-center space-x-2">
